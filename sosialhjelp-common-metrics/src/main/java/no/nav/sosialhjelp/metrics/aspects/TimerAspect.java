...
import no.nav.sosialhjelp.metrics.MetodeTimer;
...
import static no.nav.sosialhjelp.metrics.aspects.AspectUtil.getMetodenavn;
import static no.nav.sosialhjelp.metrics.aspects.AspectUtil.lagKlasseTimernavn;
import static no.nav.sosialhjelp.metrics.aspects.AspectUtil.lagMetodeTimernavn;
import static no.nav.sosialhjelp.metrics.aspects.AspectUtil.metodeSkalIgnoreres;
