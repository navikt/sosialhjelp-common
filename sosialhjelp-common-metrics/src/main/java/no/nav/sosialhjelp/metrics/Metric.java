...
import static no.nav.sosialhjelp.metrics.utils.MDCConstants.MDC_CALL_ID;
import static no.nav.sosialhjelp.metrics.utils.MDCConstants.MDC_CONSUMER_ID;
import static no.nav.sosialhjelp.metrics.utils.MDCConstants.MDC_REQUEST_ID;
import static no.nav.sosialhjelp.metrics.utils.MDCConstants.MDC_USER_ID;
